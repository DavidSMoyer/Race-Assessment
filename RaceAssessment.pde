...
void keyPressed() { // When a key is pressed...
  if (key == 'a' || key == 'A') { // If A is pressed then...
    if (win == false & sharkMove == false) { // If the shark hold prevention is false then...
     ...
     if (win == false & dolphinMove == false) { // If the dolphin hold preventon is false then...
     ...
     if (win == false & whaleMove == false) { // If the whale move prevention is false then...
